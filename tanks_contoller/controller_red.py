...
class Controller:
    ...
    def on_event(self, event):
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_k:
                pygame.draw.circle(self._display_surf, (240,128,128), [770, 360], 50)
                self._netcat(b"\x09")
            if event.key == pygame.K_l:
                pygame.draw.circle(self._display_surf, (240,128,128), [930, 360], 50)
                self._netcat(b"\x09")
    ...
    def render_nes(self):
        ...
        textsurface = ninfont.render('Tanks V1.0', False, (255,0,0))
